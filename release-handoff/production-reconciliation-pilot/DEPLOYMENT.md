...
3. Deploy backend commit `741d51ecff5fb11e522e481e32ca02ee0430052d`
   from `release/production-pilot-backend` on the existing
...
4. Use frontend commit `1d66efe668b08062faba1887992cdd3793c1e8ae`
   from `release/production-pilot-frontend`. Deploy its packaged artifact
   (build `359891`), preserving existing production static

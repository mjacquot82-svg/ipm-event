...
export default function TentedCityMap({
  initialQuery = '', initialEventTitle, initialEventId, initialParadeRoute = null, mapUnavailable = false, exactInitialPlace = false, verify1A: verify1AProp = false, onSwitchToGrounds, hideModeSelector = false,
}: {
  initialEventTitle?: string; initialEventId?: string; initialParadeRoute?: ParadeRouteId | null; initialQuery?: string | null; mapUnavailable?: boolean; exactInitialPlace?: boolean; verify1A?: boolean; onSwitchToGrounds?: (location?: string) => void; hideModeSelector?: boolean;
}) {

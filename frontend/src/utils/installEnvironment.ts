...
export function getInstallGuidance(environment: InstallEnvironment): InstallGuidance {
  ...
  if (environment.platform === 'ios' && environment.browser === 'chrome') {
    return { heading: 'Install the IPM App on your iPhone', intro: 'Follow these three taps in Chrome.', steps: [
      { cue: 'share', title: 'Tap Chrome’s Share button', hint: 'Look for the box with the arrow beside Chrome’s address bar.' },
      { cue: 'add_home', title: 'Tap “Add to Home Screen”', hint: 'Scroll down the Share list if you do not see it right away.' },
      { cue: 'install', title: 'Tap “Add”', hint: 'The IPM App will appear on your Home Screen like your other apps.' },
    ], primaryLabel: null };
  }
  if (environment.platform === 'ios' && environment.browser === 'firefox') {
    return { heading: 'Install the IPM App on your iPhone', intro: 'Follow these three taps in Firefox.', steps: [
      { cue: 'share', title: 'Tap Firefox’s Share button', hint: 'Look for the box with the arrow in Firefox’s address bar.' },
      { cue: 'add_home', title: 'Tap “Add to Home Screen”', hint: 'Scroll down the Share list if you do not see it right away.' },
      { cue: 'install', title: 'Tap “Add”', hint: 'The IPM App will appear on your Home Screen like your other apps.' },
    ], primaryLabel: null };
  }
  if (environment.platform === 'ios' && environment.browser === 'edge') {
    return { heading: 'Install the IPM App on your iPhone', intro: 'Try adding it directly from Edge.', steps: [
      { cue: 'share', title: 'Tap Share', hint: 'Look for the box with the arrow in Edge’s controls.' },
      { cue: 'add_home', title: 'Look for “Add to Home Screen”', hint: 'Scroll down the Share list if necessary.' },
      { cue: 'install', title: 'If it appears, tap it, then “Add”', hint: 'Don’t see it? No problem — continue using the IPM App here.' },
    ], primaryLabel: null };
  }
  if (environment.platform === 'ios') {
    return { heading: 'Install the IPM App on your iPhone', intro: 'Try adding it directly from this browser.', steps: [
      { cue: 'share', title: 'Tap the Share button', hint: 'Look for the box with the arrow in your browser’s controls.' },
      { cue: 'add_home', title: 'Look for “Add to Home Screen”', hint: 'Scroll down the Share list if necessary.' },
      { cue: 'install', title: 'If it appears, tap it, then “Add”', hint: 'Don’t see it? No problem — continue using the IPM App here.' },
    ], primaryLabel: null };
  }

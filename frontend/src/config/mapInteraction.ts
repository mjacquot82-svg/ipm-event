 ...
 * RvParkDetailMap (Camping) and TentedCityMap reuse these so physical feel stays aligned.
 * Optional onSingleTap supports Grounds zone hits when that map opts in.
 */

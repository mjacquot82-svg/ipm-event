...
export const PENDING_MUTUAL_SQUARE_SEGMENT: readonly RoutePoint[] = [[344, 313], [440, 313]];

const ENTRY: readonly RoutePoint[] = [PARADE_ASSEMBLY.gate, [503, 148], [440, 148], [440, 192]];
const ENTRY_ARROWS: RouteArrow[] = [
  { at: [477, 148], direction: 'west' }, { at: [440, 168], direction: 'south' },
];
export const PARADE_ROUTES: Record<ParadeRouteId, {
  ...
  tuesday: {
    ...
    paths: [ENTRY, [[440,192],[142,192],[142,437],[241,437],[241,247.5],[344,247.5],[344,437],[440,437],[440,192]]],
    arrows: [...ENTRY_ARROWS,
      ...
      { at: [440,360], direction: 'north' }, { at: [440,210], direction: 'north' }],
  },
  'wed-sat': {
    id: 'wed-sat', label: 'Wednesday–Saturday', source: 'IPM 2026 Tented City Map - Parade Route Wed to Sat.pdf',
    roads: ['Bruce County North', 'Hydro One Avenue', 'First Street', 'Dodge Avenue',
      'Fifth Street', 'Hydro One Avenue', 'First Street'],
    paths: [ENTRY, [[440,192],[142,192],[142,437],[440,437],[440,192]]],
    arrows: [...ENTRY_ARROWS,
      { at: [330,192], direction: 'west' }, { at: [142,210], direction: 'south' },
      { at: [142,345], direction: 'south' }, { at: [240,437], direction: 'east' },
      { at: [440,415], direction: 'north' }, { at: [440,330], direction: 'north' },
      { at: [440,205], direction: 'north' }],
  },
};

...
export type RouteLabel = { text: string; at: RoutePoint; angle?: 0 | 90 | -90; lines?: readonly string[]; fontSize?: number; maskLength?: number };
...
export const PARADE_ROUTES: Record<ParadeRouteId, {
  ...
  tuesday: {
    ...
    labels: [
      ...
      { text: 'Second Street', at: [292, S], maskLength: 96 }, { text: 'Grain Farmers Avenue', at: [G, 340], angle: -90, fontSize: 6 },
    ],
  },
  'wed-sat': {

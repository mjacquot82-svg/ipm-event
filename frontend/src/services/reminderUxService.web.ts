...
import {
  ...
  reconcileItineraryReminderStars,
...
export async function reconcileAttendeeItineraryReminders(starredScheduleIds: string[]) {
  await reconcileItineraryReminderStars(starredScheduleIds);
}

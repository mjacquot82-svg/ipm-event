...
const original=execFileSync('git',['show',`28c62a98cd3c52fef38b413552dc43c878b41283:${path}`],{encoding:'utf8'});
...
test('final positioning uses a yellow route caption and source-supported road labels',()=>{
 ...
 assert.match(source,/left: width \* \.68 - 75, top: height \* \.7096 \+ 7/);

// Run against a local staging build only; fixtures never contact notification providers.
...
await page.goto('http://localhost:8094/admin/',{waitUntil:'domcontentloaded'});

...
try{
 ...
 await p.goto(base+'/vendors');await p.getByTestId('vendor-education-open-map').click();await tip.getByText('Vendor location',{exact:true}).waitFor();await tip.getByRole('button',{name:'Got it',exact:true}).click();
 ...
 await p.goto(base+'/vendors');const vh=p.getByRole('button',{name:'Vendors Help',exact:true});await vh.waitFor();await vh.click();await p.getByTestId('vendor-education-open-map').click();await tip.getByText('Vendor location',{exact:true}).waitFor();await tip.getByRole('button',{name:'Got it',exact:true}).click();

...
function loadComponent(relativePath) {
  ...
  new Function('require', 'module', 'exports', code)((name) => {
    ...
    if (name.endsWith('EventDetailMedia') || name.endsWith('./EventDetailMedia')) {
      const mediaSource = readFileSync(new URL('../src/components/EventDetailMedia.tsx', import.meta.url), 'utf8');
      const mediaCode = ts.transpileModule(mediaSource, {
        compilerOptions: { jsx: ts.JsxEmit.React, module: ts.ModuleKind.CommonJS, esModuleInterop: true },
      }).outputText;
      const mediaMod = { exports: {} };
      new Function('require', 'module', 'exports', mediaCode)((n) => (n === 'react-native' ? require('react-native-web') : require(n)), mediaMod, mediaMod.exports);
      return mediaMod.exports;
    }

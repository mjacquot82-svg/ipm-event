-- Migration form of docs/platform/phase1a_notification_deliveries_migration.sql.
-- The next migration broadens the historical Webpushr-only provider constraint.
...
create table if not exists public.notification_deliveries (
  ...
  constraint notification_delivery_event_announcement_fk
    foreign key (event_id, announcement_id) references public.alerts(event_id, id) on delete cascade,
